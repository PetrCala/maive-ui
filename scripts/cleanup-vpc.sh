...
cleanup_ecr_repositories() {
  ...
  local services=("react-ui" "lambda-r-backend")
...
cleanup_cloudwatch_logs() {
  ...
  local log_groups=("/ecs/${PROJECT_NAME}/react-ui" "/ecs/${PROJECT_NAME}/lambda-r-backend" "/aws/lambda/${PROJECT_NAME}-r-backend" "/aws/vpc/flowlog")
