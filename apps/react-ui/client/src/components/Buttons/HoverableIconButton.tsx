...
function HoverableIconButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`p-2 text-secondary transition-colors duration-200 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group focus-ring icon-button ${buttonClassName}`}
