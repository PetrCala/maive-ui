...
- **GitHub Issues:** [${CONST.LINKS.APP_GITHUB.HOMEPAGE.replace("https://", "")}/issues](${CONST.LINKS.APP_GITHUB.ISSUES})
- **Documentation:** [meta-analysis.cz/maive](${CONST.LINKS.MAIVE.WEBSITE})
- **R Package:** [${CONST.LINKS.MAIVE.GITHUB.replace("https://", "")}](${CONST.LINKS.MAIVE.GITHUB})
...
**Package URL:** [${CONST.LINKS.APP_GITHUB.HOMEPAGE.replace("https://", "")}](${CONST.LINKS.APP_GITHUB.HOMEPAGE})
`;
}
